...
export default function Question(props) {
    const { personality, setPersonality, setReply } = useContext(GlobalContext)
    ...
    return (
        <div className="container">
            ...
            <div className="flex flex-row w-full place-content-center">
                <div className="w-full self-center mx-3">
                    <form className="flex flex-col" onSubmit={handleModeSelection}>
                        <label className="dark:text-black" htmlFor="mode">Select a mode:</label>
                        <div className="flex flex-row">
                            <select
                                name="mode"
                                value={mode}
            ...
            <div className="flex flex-row w-full place-content-center">
                <div className="flex flex-col w-full self-center mx-3">
                    <label className="dark:text-black" htmlFor="temperature">Temperature:</label>
                    <input
            ...
            <div className="flex flex-row w-full place-content-center mb-2">
                <div className="w-full self-center mx-3">
                    <form className="flex flex-col" onSubmit={handleSubmit}>
                        <label className="dark:text-black" htmlFor="question">Question:</label>
                        <div className="flex flex-row">
                            <input
                                className="basis-5/6 border-2 border-black-300 dark:bg-white dark:text-black"
                                type="text"
